...
HTML_IMG_TEMPLATE = """
    ...
    <img src="data:image/png;base64, {}" width="270px" height="480px"/>
    </a>
    <br></br>
"""
...
class ReportTestResult(unittest.TestResult):
    ...
    def stopTest(self, test) -> None:
        ...
        self.end_time = '{0:.1f}s'.format((time.time() - self.start_time))
    ...
    def add_test_img(*pargs):
        ...
        def _wrap(func):
            ...
            def __wrap(*args, **kwargs):
                ...
                # img_path = os.path.abspath('{}'.format(HTMLReport.img_path))
                img_path = getattr(args[0], 'report_img_path')
                try:
